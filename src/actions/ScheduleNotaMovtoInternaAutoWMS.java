...
public class ScheduleNotaMovtoInternaAutoWMS implements ScheduledAction {
    @Override
    public void onTime(ScheduledActionContext scheduledActionContext) {

        BigDecimal nuNota = new BigDecimal(0);

        List<TransfCabModel> listCabTransf = null;
        try {
            listCabTransf = MovInternaAutoDAO.consultaCabArmParciaisFinalizados();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        System.out.println("Notas de Transferências geradas com sucesso.");
